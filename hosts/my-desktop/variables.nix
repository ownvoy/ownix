{
  ...
  # extraMonitorSettings = "monitor=HDMI-A-1,2560x1440@60.000,auto,1";
  # extraMonitorSettings = "monitor=HDMI-A-1,2560x1440@60.000,auto,1,transform, 3
  # montior=DP-1, 2560x1440@199.99,auto,1
  # ";
